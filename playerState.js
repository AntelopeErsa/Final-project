...
export class Running extends State {
    ...
    handleInput(input){
        this.game.particles.unshift(new Dust(this.game, this.game.player.x + this.game.player.width * 0.5, this.game.player.y + this.game.player.height + -10));
        if (input.includes('s')){
...
export class Rolling extends State {
    ...
    handleInput(input){
        ...
        if (!input.includes('q') && this.game.player.onGround()){
            this.game.player.setState(states.RUNNING, 1);
        } else if (!input.includes('q') && !this.game.player.onGround()){
                this.game.player.setState(states.FALLING, 1);
        } else if (input.includes('q') && input.includes('w') && this.game.player.onGround()){
